...
const coverHeading = container.querySelector('.cover__heading')
 coverHeading.addEventListener('mousever',function(evt){
  console.log('навидение мыши');
...
// coverHeading.addEventListener('mousedown',function(){
//   console.log('кнопка в нижнем положение');
// })
